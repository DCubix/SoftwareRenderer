...
#
# Based on FindSDL_gfx.cmake, created by Eric Wing, modified to find
# SDL_gfx by Magnus Ahlberg.
...
IF( NOT SDLGFX_INCLUDE_DIR)
	IF( NOT SDL_gfx_FIND_QUIETLY AND SDL_gfx_FIND_REQUIRED)
		MESSAGE( FATAL_ERROR "Could NOT find SDL_gfx header")
	ENDIF( NOT SDL_gfx_FIND_QUIETLY AND SDL_gfx_FIND_REQUIRED)
ENDIF( NOT SDLGFX_INCLUDE_DIR)

IF ( NOT SDLGFX_LIBRARY)
	IF( NOT SDL_gfx_FIND_QUIETLY AND SDL_gfx_FIND_REQUIRED)
		MESSAGE( FATAL_ERROR "Could NOT find SDL_gfx library")
	ENDIF( NOT SDL_gfx_FIND_QUIETLY AND SDL_gfx_FIND_REQUIRED)
ENDIF ( NOT SDLGFX_LIBRARY)
